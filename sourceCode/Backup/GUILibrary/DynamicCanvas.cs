...
namespace Adsophic.PhotoEditor.GUILibrary
{
    /// <summary>
    ...
    {
        static DynamicCanvas()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(DynamicCanvas), new FrameworkPropertyMetadata(typeof(DynamicCanvas)));
        }
